...
//TODO: Uncomment back the temporary thermal protection removal so it will function again!
...
#define DELTA
  ...
  #define DELTA_DIAGONAL_ROD 337.5 // mm

  // height from z=0 to home position
  #define DELTA_HEIGHT 302.36 // get this value from auto calibrate

  #define DELTA_ENDSTOP_ADJ { -5.97, -2.56, 0.0 } // get these from auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 163 //mm  Get this value from auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { -0.74, 0.15, 0.59 } // get these values from auto calibrate
...
//Taken from Taras code
#define DEFAULT_AXIS_STEPS_PER_UNIT   {57, 57, 57, 125}
...
//https://www.olx.ua/obyavlenie/bfptouch-zond-avtovimryuvannya-visoti-stolu-3d-printera-analog-bltouch-IDEtlCr.html

#define Z_MIN_ENDSTOP_INVERTING false // Set to true to invert the logic of the endstop.
#define Z_MIN_PROBE_ENDSTOP_INVERTING false // Set to true to invert the logic of the probe.

#define Z_PROBE_SERVO_NR 0 // Defaults to SERVO 0 connector.
#define Z_SERVO_ANGLES {200,115} // Z Servo Deploy and Stow angles
